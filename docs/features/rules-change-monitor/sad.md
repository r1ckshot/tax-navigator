...
запуску за розкладом. Сім модулів-файлів плюс `states.mjs` (доданий при
реалізації 2026-08-26: перелік станів мусив стати спільним контрактом, інакше
три модулі писали б рядок стану літералом кожен свій), кожен відповідає за одне
...
├── states.mjs      <перелік 7 станів AC-03 + форма RuleCheck — спільний контракт>
