...
**Фаза [POLISH.md](POLISH.md), крок 1 закрито 2026-09-16 (S-2, S-3, S-4), сесія 5
закрита того ж дня. Цикли G1 крутяться на VPS самі; наступна сесія починає
`rules-change-monitor`: пауза між запитами до одного домену і challenge-сторінка
WAF (сесія 6).**
