...
**M5 capstone, Етап 1 з 5** — гілка `feat/f1-umowa-zlecenie`, вимір у
[CAPSTONE_LOG.md](../CAPSTONE_LOG.md). F1 (руками, без плагіна) зроблена:
...
- [ ] Візуальний рев'ю Mike (таблиця на 5 рядків) — не пройдено
- [ ] PR #1 не відкрито
