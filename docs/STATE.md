...
6 сценаріїв рахуються детерміновано на клієнті. 182 node-тести + 15 UI зелені.
...
- [x] P6 розблокований правкою движка: ричалт тепер віднімає фактичні витрати
      від «на руки» (база податку лишається приходом). Дефект давав розрив
      6,000 zł/міс при витратах 40% і **перевертав** залежність — що більші
      витрати, то привабливішим виглядав ричалт. Калібрувальний приклад у
      EVIDENCE §6 перерахований: смуга ричалту 10,073–10,912 → 9,352–10,132
...
- **G2 не пройдені** — лишились документи: PROJECT §G2 і EVIDENCE §7 досі
  описують еталон, якого немає (держкалькулятор для PIT). Усі 10 профілів
  закріплені й зелені.
