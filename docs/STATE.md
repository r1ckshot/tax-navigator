...
2026-08-25 ([docs/capstones/m9.md](capstones/m9.md)). Пріоритет поза курсом
лишається реальний білд: T1+T2 `tg-assistant` за `tasks/tracker.md`.
...
**M9 Collaboration закрито повністю — 2026-08-25 здано капстоун модуля.**
...
`RUNBOOK.md` у теці `9-collaboration` курсової збірки. Наступний модуль — M10
Agent teams, тексти завдань ще не надані.
