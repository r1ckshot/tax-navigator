...
6 сценаріїв рахуються детерміновано на клієнті. 210 node-тестів + 17 UI зелені.
...
**M10 Agent teams у роботі з 2026-08-25, уроки 10.1-10.5 закриті, лишився капстоун модуля.**
