...
Лишилось:
- [ ] **Перевірити хук у новій сесії** — правки `.claude/settings.json` підхоплюються
  лише на старті, тож у цій сесії він не спрацював (записано в `environment-limits.md`)
- [ ] Два виклики скіла для здачі M5.3 — явний і природномовний
