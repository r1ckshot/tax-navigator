...
**M5 capstone, Етап 3 з 5** — гілка `feat/m5-capstone-plugin`, вимір у
...
### Наступний крок: Етапи 4–5 capstone

1. Звірити `scripts/state-checkpoint/` (5.7 SDK) з рубрикою завдання capstone.
2. Публікація в [team-marketplace](https://github.com/r1ckshot/team-marketplace).
3. PR #2 в `master` — в описі **явно назвати команди плагіна**, бо саме вони є
   предметом здачі. Гілку для наступної роботи брати від `master` після мерджу.
