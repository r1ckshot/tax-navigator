...
6 сценаріїв рахуються детерміновано на клієнті. 380 node-тестів + 25 UI зелені.
...
**Фаза [POLISH.md](POLISH.md), крок 1 закрито 2026-09-16 (S-2, S-3, S-4). Цикли
G1 крутяться на VPS самі; наступна сесія починає `rules-change-monitor`: veto-гілка,
реєстр veto, місячний звіт (сесія 5).**
